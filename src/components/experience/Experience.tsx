...
const Experience:React.FC = () => {
    return(
        <Section title={"My Experience"} topTitle={"What Skills I Have"} sectionId={"experience"}>
            <ul className={"grid grid-cols-1 md:grid-cols-2 gap-10 mt-14"}>
                <li className={"bg-backgroundLight w-full h-96 rounded-3xl"}>
                    <h2 className={"text-primary text-xl pt-8 pb-2"}>Frontend Development</h2>
                    <div className={"text-sm underline cursor-pointer pb-8 text-primaryLight hover:text-white"}>download CV</div>
                    <ul className={"grid grid-cols-2 md:grid-cols-3 gap-6 px-10"}>
                ...
                <li className={"bg-backgroundLight w-full h-96 rounded-3xl"}>
                    <h2 className={"text-primary text-xl pt-8 pb-2"}>Backend Development</h2>
                    <div className={"text-sm underline cursor-pointer pb-8 text-primaryLight hover:text-white"}>download CV</div>
                    <ul className={"grid grid-cols-2 md:grid-cols-3 gap-6 px-10"}>
                ...
                <li className={"bg-backgroundLight w-full h-96 rounded-3xl"}>
                    <h2 className={"text-primary text-xl pt-8 pb-2"}>Mobile Development</h2>
                    <div className={"text-sm underline cursor-pointer pb-8 text-primaryLight hover:text-white"}>download CV</div>
                    <ul className={"grid grid-cols-2 md:grid-cols-3 gap-6 px-10"}>
                ...
                <li className={"bg-backgroundLight w-full h-96 rounded-3xl"}>
                    <h2 className={"text-primary text-xl p-8"}>Others</h2>
                    <ul className={"grid grid-cols-2 md:grid-cols-3 gap-6 px-10"}>
